...
<div id="page_content">
                        ...
                        <div class="uk-grid uk-grid-divider uk-grid-medium">
                            <div class="uk-width-large-1-3">
                                <div class="uk-grid uk-grid-small">
                                    <div class="uk-width-large-1-3">
                                        <span class="uk-text-muted uk-text-small">Mã loại sản phẩm</span>
                                    </div>
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle"><?php  echo $lsp->MaLoaiSP; ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="uk-width-large-1-3">
                               <div class="uk-grid uk-grid-small">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle"><?php  echo $lsp->TenLoaiSP; ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="uk-width-large-1-3">
    ...
    <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent" href="index.php?c=duan&a=edit&id=<?php echo $lsp->MaLoaiSP;?>">
