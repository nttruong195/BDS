<div class="uk-grid uk-grid-divider uk-grid-medium">
	<div class="uk-width-large-2-2">
        <p>
            <span class="uk-text-muted uk-text-small uk-display-block uk-margin-small-bottom">Chọn nhân viên</span>
            <select id="select_demo_1" data-md-selectize data-placeholder="Chọn nhân viên">
                <option value="a">Nhân viên 1</option>
                <option value="b">Nhân viên 2</option>
                <option value="c">Nhân viên 3</option>
            </select>
		</p>
        			...
        			<div class="uk-grid uk-grid-divider uk-grid-medium">
                    	<div class="uk-width-large-1-2">
                            ...
                            <div class="md-card-content">
		                        ...
		                        <div id="doanhthu_nhanvien" class="c3chart"></div>
		                    </div>
                    	</div>
                    	<div class="uk-width-large-1-2">
		                    ...
		                    <div class="md-card-content">
		                        <div class="md-card-content">
		                            ...
		                            <div id="hopdong_nhanvien" class="c3chart"></div>
		                        </div>
		                    </div>
                    	</div>
        			</div>
            	...
            	<div class="uk-accordion-content">
                	...
                	<div class="uk-grid uk-grid-divider uk-grid-medium">
                        <div class="uk-width-large-1-2">
                            <div class="md-card-content">
                                <!-- <h4 class="heading_c uk-margin-bottom">Doanh thu tháng này</h4> -->
                                <div id="nam_doanhthu_nhanvien" class="c3chart"></div>
                            </div>
                        </div>
                        <div class="uk-width-large-1-2">
                            <div class="md-card-content">
                                <div class="md-card-content">
                                    <!-- <h4 class="heading_c uk-margin-bottom">Tỷ lệ doanh thu</h4> -->
                                    <div id="nam_hopdong_nhanvien" class="c3chart"></div>
                                </div>
                            </div>
                        </div>
                    </div>
