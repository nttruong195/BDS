...
?>
    ...
    <div id="page_content">
                  ...
                  <div class="md-card-content">
                      <div class="uk-grid" data-uk-grid-margin>
                          <div class="uk-width-large-1-2">
                              ...
                              <form class="uk-form-stacked">
                                  <label for="kUI_combobox_input" class="uk-form-label">Chọn dự án </label>
        ...
        <div id="page_content_inner">
            ...
            <h3 class="heading_b uk-margin-bottom">Báo cáo- thống kê DỰ ÁN</h3>
            <div class="uk-grid" data-uk-grid-margin>
    ...
    <script>
        ...
        $(function () {
           $('#BCTK_DuAn').click(function () {
               window.location="index.php?c=no&a=danhsach";
           });
       });
    ...
    <!-- datatables colVis-->
    <script src="public/js/admin/dataTables.colVis.js"></script>
    <!-- datatables tableTools-->
    <script src="public/js/admin/dataTables.tableTools.js"></script>
    <!-- datatables custom integration -->
    <script src="public/js/admin/datatables_uikit.min.js"></script>

    <!--  datatables functions -->
    <script src="public/js/admin/plugins_datatables.min.js"></script>
  ...
  <!--  kendoui functions -->
  <script src="public/js/admin/kendoui.min.js"></script>
    <!-- enable hires images -->
