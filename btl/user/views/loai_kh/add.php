...
<div id="page_content">
        <div id="page_content_inner">
            <h3 class="heading_b uk-margin-bottom">Thêm loại khách hàng</h3>
                ...
                <div class="md-card">
                    ...
                    <div class="md-card-content large-padding">
                                <div class="uk-grid uk-grid-small">
                                    ...
                                    <input type="text" class="md-input" id="TenLoaiKH" name="name" value = ""/>
                                </div><br>
...
function SubmitLKH(){
  ...
  $.post(
    ...
    {TenLoaiKH: $('#TenLoaiKH').val(), MoTa: value},
    function(data)
    {
